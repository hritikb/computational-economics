...
plt.savefig('D:/Projects/Computational Economics/discrete-time-discrete-state/mine-management/optimal_value_function.png')
plt.show()
...
plt.savefig('D:/Projects/Computational Economics/discrete-time-discrete-state/mine-management/optimal_extraction_policy.png')
plt.show()
...
plt.ylabel('Stock')
# plt.title('The plot shows the optimal extraction strategy for the possible values of the stock of ore')
plt.savefig('D:/Projects/Computational Economics/discrete-time-discrete-state/mine-management/optimal_state_path.png')
plt.show()
...
plt.ylabel('Reward')
# plt.title('The plot shows the optimal extraction strategy for the possible values of the stock of ore')
plt.savefig('D:/Projects/Computational Economics/discrete-time-discrete-state/mine-management/yearwise_reward.png')
plt.show()